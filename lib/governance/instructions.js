...
(function (GovernanceInstruction) {
    ...
    GovernanceInstruction[GovernanceInstruction["CreateTransactionBuffer"] = 29] = "CreateTransactionBuffer";
    GovernanceInstruction[GovernanceInstruction["ExtendTransactionBuffer"] = 30] = "ExtendTransactionBuffer";
    GovernanceInstruction[GovernanceInstruction["CloseTransactionBuffer"] = 31] = "CloseTransactionBuffer";
    GovernanceInstruction[GovernanceInstruction["InsertVersionedTransactionFromBuffer"] = 32] = "InsertVersionedTransactionFromBuffer";
    GovernanceInstruction[GovernanceInstruction["InsertVersionedTransaction"] = 33] = "InsertVersionedTransaction";
    GovernanceInstruction[GovernanceInstruction["ExecuteVersionedTransaction"] = 34] = "ExecuteVersionedTransaction";
    GovernanceInstruction[GovernanceInstruction["RemoveVersionedTransaction"] = 35] = "RemoveVersionedTransaction";
