...
exports.withInsertVersionedTransaction = void 0;
...
const withInsertVersionedTransaction = (instructions, programId, governance, proposal, tokenOwnerRecord, governanceAuthority, payer, optionIndex, ephemeralSigners, transactionIndex, transactionMessage) => {
    const args = new instructions_1.InsertVersionedTransactionArgs({
        optionIndex,
        ephemeralSigners,
        transactionIndex,
        transactionMessage,
...
exports.withInsertVersionedTransaction = withInsertVersionedTransaction;
//# sourceMappingURL=withInsertVersionedTransaction.js.map