import { Keypair, type PublicKey, TransactionInstruction } from "@solana/web3.js";
import { GOVERNANCE_CHAT_SCHEMA } from "./serialisation";
import { serialize } from "borsh";
import { PostChatMessageArgs } from "./instructions";
import { GOVERNANCE_CHAT_PROGRAM_ID, type ChatMessageBody } from "./accounts";
...
export async function withPostChatMessage(
	...
	await withRealmConfigPluginAccounts(keys, governanceProgramId, realm, voterWeightRecord);
