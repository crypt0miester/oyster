import { type PublicKey, SYSVAR_CLOCK_PUBKEY, SYSVAR_RENT_PUBKEY, TransactionInstruction } from "@solana/web3.js";
import { getGovernanceInstructionSchema } from "./serialisation";
import { serialize } from "borsh";
import { CastVoteArgs, type Vote } from "./instructions";
...
export const withCastVote = async (
	...
	const voteRecordAddress = await getVoteRecordAddress(programId, proposal, tokenOwnerRecord);
	...
	await withRealmConfigPluginAccounts(keys, programId, realm, voterWeightRecord, maxVoterWeightRecord);
