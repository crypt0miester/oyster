...
import {
	...
	type GoverningTokenConfigAccountArgs,
...
export function createRealmConfigArgs(
	...
	assertValidTokenConfigArgs(programVersion, communityTokenConfig, GoverningTokenRole.Community);
	assertValidTokenConfigArgs(programVersion, councilTokenConfig, GoverningTokenRole.Council);
	...
	return new RealmConfigArgs({
		...
		// VERSION == 2
		useCommunityVoterWeightAddin: communityTokenConfig?.voterWeightAddin !== undefined,
		useMaxCommunityVoterWeightAddin: communityTokenConfig?.maxVoterWeightAddin !== undefined,

		// VERSION >= 3
		communityTokenConfigArgs: new GoverningTokenConfigArgs({
			useVoterWeightAddin: communityTokenConfig?.voterWeightAddin !== undefined,
			useMaxVoterWeightAddin: communityTokenConfig?.maxVoterWeightAddin !== undefined,
		...
		councilTokenConfigArgs: new GoverningTokenConfigArgs({
			...
			useMaxVoterWeightAddin: councilTokenConfig?.maxVoterWeightAddin !== undefined,
