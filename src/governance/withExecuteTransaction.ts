import { type PublicKey, SYSVAR_CLOCK_PUBKEY, TransactionInstruction } from "@solana/web3.js";
import { getGovernanceInstructionSchema } from "./serialisation";
import { serialize } from "borsh";
import { ExecuteTransactionArgs } from "./instructions";
import { AccountMetaData, getNativeTreasuryAddress, type InstructionData } from "./accounts";
...
export const withExecuteTransaction = async (
	...
	for (const instruction of transactionInstructions) {
		...
		instruction.accounts = instruction.accounts.map((a) =>
			(a.pubkey.toBase58() === governance.toBase58() || a.pubkey.toBase58() === nativeTreasury.toBase58()) && a.isSigner
				? new AccountMetaData({
						pubkey: a.pubkey,
