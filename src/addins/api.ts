...
export async function getMaxVoterWeightRecord(connection: Connection, maxVoterWeightRecordPk: PublicKey) {
	return getGovernanceAddinAccount(connection, maxVoterWeightRecordPk, MaxVoterWeightRecord);
}

export async function getVoterWeightRecord(connection: Connection, voterWeightRecordPk: PublicKey) {
...
export async function getGovernanceAddinAccount<TAccount>(
	...
	return GovernanceAddinAccountParser(accountClass as any)(accountPk, accountInfo) as ProgramAccount<TAccount>;
}
