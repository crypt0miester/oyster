...
export type GovernanceAddinAccountClass = typeof VoterWeightRecord | MaxVoterWeightRecord;
...
export async function getMaxVoterWeightRecordAddress(
	...
	const [maxVoterWeightRecordAddress] = await PublicKey.findProgramAddress(
		[Buffer.from("max-voter-weight-record"), realm.toBuffer(), governingTokenMint.toBuffer()],
		programId,
	);
