import { type GovernanceAddinAccountClass, MaxVoterWeightRecord, VoterWeightRecord } from "./accounts";
...
export const GovernanceAddinAccountParser = (classType: GovernanceAddinAccountClass) =>
